...
vect2&	vect2::operator+=(const vect2& v)	{	return (_x += v._x, _y += v._y, *this);	}
vect2&	vect2::operator-=(const vect2& v)	{	return (_x -= v._x, _y -= v._y, *this);	}

//ADD: operator++(), ++_x/_y
vect2&	vect2::operator++()	{	return (++_x, ++_y, *this);	}
vect2&	vect2::operator--()	{	return (--_x, --_y, *this);	}

// ADD: int parameter (as place-holder), full implementation 
vect2	vect2::operator++(int)	{	vect2 tmp(*this);  return (++*this, tmp);	}
vect2	vect2::operator--(int)	{	vect2 tmp(*this);  return (--*this, tmp);	}

//DIFFERENCE: const member function
int&	vect2::operator[](int i)		{	return i ? _y : _x;	}
const int&  vect2::operator[](int i) const	{	return i ? _y : _x;	}

//unary '-', int multi, binary arithmetic operator
...
vect2&	vect2::operator*=(int n)	{	return (_x *= n, _y *= n, *this);	}

//BOOLEAN: "==" and "!="
bool	vect2::operator==(const vect2& v) const	 {	return _x == v._x && _y == v._y; }
